...
最終更新: 2026-04-06 (T-009介入実験完了 / exp003b・exp003c・exp004実行 / Layer 1着手準備)
...
| M4 | Mode R 回答収集 (Phase 2) | 2026-06 | 🟡 次に着手 |
| M5 | 介入 I1 シミュレーション実行 (Phase 3) | 2026-06 | ✅ 完了 |
| M6 | 三層検証プロトコル実施 (Phase 4) | 2026-07 | 🟢 進行中 |
...
- [ ] **T-008** Mode R 質問プロンプト設計 + 回答構造化 → Layer 1 創発性テスト — exp004の観察結果に対するMode R予測を収集し Emergence Ratio を算出

### 🟡 Next Up

- [ ] **T-010** Layer 1: Emergence Ratio 算出スクリプト（T-008の結果を入力として使用）
- [ ] **T-015** buyer_a awaiting_receipt フィルター非対称性の修正判断
- [ ] **T-016** 複数 seed での再現性検証（exp003 パラメータ、seed=43,44,45）
