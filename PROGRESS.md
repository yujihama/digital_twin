...
- [x] **T-012** Layer 3 相互作用遮断テスト。baseline/intervention × full/isolated = 4実験。6件の創発事象全てが遮断下でも維持され、相互作用に本質的に依存するものは0件と判定。創発の主因は閾値変更による構造的因果連鎖。相互作用は「効率最適化」の潤滑油として機能（2026-04-06）
