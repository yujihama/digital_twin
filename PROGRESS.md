...
| M1 | 購買承認フロー Environment State 実装 | 2026-04 | 🟡 未着手 |
...
- [ ] **T-001** Environment State スキーマの Python 実装（`experiments/runtime/environment.py`）
- [ ] **T-002** 状態遷移ルールの実装（承認・三者照合・日次キャパシティ）
